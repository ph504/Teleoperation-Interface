...
message(STATUS "axis_camera: 1 messages, 0 services")

set(MSG_I_FLAGS "-Iaxis_camera:/home/pouya/catkin_ws/src/axis_camera/msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/pouya/catkin_ws/src/axis_camera/msg/Axis.msg" NAME_WE)
add_custom_target(_axis_camera_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "axis_camera" "/home/pouya/catkin_ws/src/axis_camera/msg/Axis.msg" ""
)
...
_generate_msg_cpp(axis_camera
  "/home/pouya/catkin_ws/src/axis_camera/msg/Axis.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/axis_camera)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/axis_camera\")")
  # install generated code
  install(
