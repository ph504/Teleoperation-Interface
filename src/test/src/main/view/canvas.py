...
#     def __init__(self, r, info_dict):
#         super().__init__(r, info_dict)
#         self.color_lightgreen = gs.COLOR_CODE["light_green"]
#         self.color_yellow = gs.COLOR_CODE["yellow"]
#         self.color_orange = gs.COLOR_CODE["orange"]
#         self.color_red = gs.COLOR_CODE["red"]
#         self.state = "green"
